...
remainingAxioms = delete(Ep - mp, remainingAxioms);
remainingAxioms = delete(Ev - pv, remainingAxioms);
remainingAxioms = delete(Emu^2 - pmu^2 - mmu^2, remainingAxioms);
...
-- Output
f = openOut "results/decay/dimensionality_check/3_axioms_removed/subset_8/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ep - mp, Ev - pv, Emu^2 - pmu^2 - mmu^2}) << endl;
