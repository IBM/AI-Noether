...
-- Output
f = openOut "results/decay/dimensionality_check/3_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pv - pmu, Ep - Emu - Ev, Emu^2 - pmu^2 - mmu^2}) << endl;
