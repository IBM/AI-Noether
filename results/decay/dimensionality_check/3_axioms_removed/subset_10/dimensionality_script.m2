...
-- Output
f = openOut "results/decay/dimensionality_check/3_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ev - pv, Ep - Emu - Ev, Emu^2 - pmu^2 - mmu^2}) << endl;
