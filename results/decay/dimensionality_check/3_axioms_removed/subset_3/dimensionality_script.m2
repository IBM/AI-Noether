...
-- Output
f = openOut "results/decay/dimensionality_check/3_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pv - pmu, Ep - mp, Emu^2 - pmu^2 - mmu^2}) << endl;
