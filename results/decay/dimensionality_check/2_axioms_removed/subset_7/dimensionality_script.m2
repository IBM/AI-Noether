...
-- Output
f = openOut "results/decay/dimensionality_check/2_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ep - mp, Emu^2 - pmu^2 - mmu^2}) << endl;
