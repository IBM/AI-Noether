...
qList = toList([(20013/10000)*pv*mp - (10027/10000)*mp^2 + (9988/10000)*mmu^2]);
...
f = openOut "results/decay/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_2/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/decay/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_2/decomposition/witness_sets/witness_set.txt");
