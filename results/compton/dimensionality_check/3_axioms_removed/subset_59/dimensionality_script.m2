...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_59/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, lambda2*f2 - c, Ee1 - me*c^2}) << endl;
