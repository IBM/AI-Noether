...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_66/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E2 - h*f2, p1*c - h*f1, lambda1*f1 - c}) << endl;
