...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_67/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E2 - h*f2, p1*c - h*f1, lambda2*f2 - c}) << endl;
