...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_92/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, lambda1*f1 - c, Ee1 - me*c^2}) << endl;
