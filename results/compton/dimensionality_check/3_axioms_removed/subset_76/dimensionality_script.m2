...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_76/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E2 - h*f2, lambda1*f1 - c, lambda2*f2 - c}) << endl;
