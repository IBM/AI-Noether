...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_80/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E2 - h*f2, lambda2*f2 - c, Ee1 - me*c^2}) << endl;
