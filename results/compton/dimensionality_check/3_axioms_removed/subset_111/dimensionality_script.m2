...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_111/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({lambda1*f1 - c, lambda2*f2 - c, Ee1 - me*c^2}) << endl;
