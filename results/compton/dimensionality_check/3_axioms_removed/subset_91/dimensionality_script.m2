...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_91/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, lambda1*f1 - c, lambda2*f2 - c}) << endl;
