...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_39/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, E2 - h*f2, lambda1*f1 - c}) << endl;
