...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_17/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 + Ee1 - E2 - Ee2, p1*c - h*f1, lambda1*f1 - c}) << endl;
