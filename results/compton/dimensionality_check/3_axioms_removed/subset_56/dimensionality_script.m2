...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_56/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, lambda1*f1 - c, Ee1 - me*c^2}) << endl;
