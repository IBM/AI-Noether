...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_87/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, p2*c - h*f2, lambda2*f2 - c}) << endl;
