...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_27/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 + Ee1 - E2 - Ee2, lambda1*f1 - c, lambda2*f2 - c}) << endl;
