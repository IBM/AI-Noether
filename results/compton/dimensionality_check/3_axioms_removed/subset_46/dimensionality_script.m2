...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_46/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, p1*c - h*f1, lambda2*f2 - c}) << endl;
