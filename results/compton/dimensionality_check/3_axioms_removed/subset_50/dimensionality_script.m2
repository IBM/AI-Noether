...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_50/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, p2*c - h*f2, lambda1*f1 - c}) << endl;
