...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_86/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, p2*c - h*f2, lambda1*f1 - c}) << endl;
