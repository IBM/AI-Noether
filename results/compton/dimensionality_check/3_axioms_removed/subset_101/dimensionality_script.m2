...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_101/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p2*c - h*f2, lambda1*f1 - c, lambda2*f2 - c}) << endl;
