...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_71/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E2 - h*f2, p2*c - h*f2, lambda1*f1 - c}) << endl;
