...
remainingAxioms = delete(lambda1*f1 - c, remainingAxioms);
remainingAxioms = delete(Ee2^2 - pe2^2*c^2 - me^2*c^4, remainingAxioms);
remainingAxioms = delete(pe2^2 - p1^2 - p2^2 + 2*p1*p2*coss, remainingAxioms);
...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_116/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({lambda1*f1 - c, Ee2^2 - pe2^2*c^2 - me^2*c^4, pe2^2 - p1^2 - p2^2 + 2*p1*p2*coss}) << endl;
