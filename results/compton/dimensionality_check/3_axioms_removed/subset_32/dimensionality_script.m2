...
-- Output
f = openOut "results/compton/dimensionality_check/3_axioms_removed/subset_32/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 + Ee1 - E2 - Ee2, lambda2*f2 - c, Ee2^2 - pe2^2*c^2 - me^2*c^4}) << endl;
