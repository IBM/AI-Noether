...
-- Output
f = openOut "results/compton/dimensionality_check/1_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pe2^2 - p1^2 - p2^2 + 2*p1*p2*coss}) << endl;
