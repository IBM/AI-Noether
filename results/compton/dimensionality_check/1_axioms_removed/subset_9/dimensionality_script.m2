...
-- Output
f = openOut "results/compton/dimensionality_check/1_axioms_removed/subset_9/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ee2^2 - pe2^2*c^2 - me^2*c^4}) << endl;
