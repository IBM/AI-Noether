...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_13/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, lambda1*f1 - c}) << endl;
