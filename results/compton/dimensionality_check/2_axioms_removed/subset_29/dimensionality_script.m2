...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_29/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, Ee2^2 - pe2^2*c^2 - me^2*c^4}) << endl;
