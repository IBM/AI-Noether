...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_28/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, Ee1 - me*c^2}) << endl;
