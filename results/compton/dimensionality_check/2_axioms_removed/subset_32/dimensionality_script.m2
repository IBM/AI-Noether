...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_32/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p2*c - h*f2, lambda2*f2 - c}) << endl;
