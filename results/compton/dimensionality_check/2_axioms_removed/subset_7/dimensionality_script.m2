...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 + Ee1 - E2 - Ee2, Ee1 - me*c^2}) << endl;
