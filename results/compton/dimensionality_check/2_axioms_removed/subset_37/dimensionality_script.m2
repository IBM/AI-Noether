...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_37/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({lambda1*f1 - c, Ee1 - me*c^2}) << endl;
