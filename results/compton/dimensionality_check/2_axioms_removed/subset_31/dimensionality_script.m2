...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_31/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p2*c - h*f2, lambda1*f1 - c}) << endl;
