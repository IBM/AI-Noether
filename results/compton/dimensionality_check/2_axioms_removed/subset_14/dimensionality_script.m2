...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_14/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E1 - h*f1, lambda2*f2 - c}) << endl;
