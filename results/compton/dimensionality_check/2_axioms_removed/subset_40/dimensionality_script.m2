...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_40/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({lambda2*f2 - c, Ee1 - me*c^2}) << endl;
