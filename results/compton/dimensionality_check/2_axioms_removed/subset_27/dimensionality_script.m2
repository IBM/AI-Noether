...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_27/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({p1*c - h*f1, lambda2*f2 - c}) << endl;
