...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_36/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({lambda1*f1 - c, lambda2*f2 - c}) << endl;
