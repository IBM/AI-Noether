...
-- Output
f = openOut "results/compton/dimensionality_check/2_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({E2 - h*f2, lambda1*f1 - c}) << endl;
