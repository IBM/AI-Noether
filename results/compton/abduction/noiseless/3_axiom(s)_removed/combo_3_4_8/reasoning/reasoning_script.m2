...
-- Input data
remainingAxioms = toList([E1 + Ee1 - E2 - Ee2, E1 - h*f1, p2*c - h*f2, lambda1*f1 - c, lambda2*f2 - c, Ee2^2 - pe2^2*c^2 - me^2*c^4, pe2^2 - p1^2 - p2^2 + 2*p1*p2*coss]);
...
-- Output file
f = openOut "results/compton/abduction/noiseless/3_axiom(s)_removed/combo_3_4_8/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/compton/abduction/noiseless/3_axiom(s)_removed/combo_3_4_8/reasoning/reasoning_output.txt");
