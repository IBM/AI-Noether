...
remainingAxioms = toList([Eph1 + Eel1 - Eph2- Eel2, Eph1 - hbar*f1, Eph2 - hbar*f2, p1*cVar - hbar*f1, lam1*f1 - cVar, lam2*f2 - cVar, Eel1 - mel*cVar^2]);
...
f = openOut "results/compton/abduction/noisy/noise_1e-2/3_axiom(s)_removed/combo_5_9_10/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/compton/abduction/noisy/noise_1e-2/3_axiom(s)_removed/combo_5_9_10/decomposition/witness_sets/witness_set.txt");
