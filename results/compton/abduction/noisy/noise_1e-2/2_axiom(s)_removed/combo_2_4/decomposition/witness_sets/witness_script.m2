...
remainingAxioms = toList([Eph1 + Eel1 - Eph2- Eel2, Eph2 - hbar*f2, p2*cVar - hbar*f2, lam1*f1 - cVar, lam2*f2 - cVar, Eel1 - mel*cVar^2, Eel2^2 - pel2^2*cVar^2 - mel^2*cVar^4, pel2^2 - p1^2 - p2^2 + 2*p1*p2*cosTh]);
...
f = openOut "results/compton/abduction/noisy/noise_1e-2/2_axiom(s)_removed/combo_2_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/compton/abduction/noisy/noise_1e-2/2_axiom(s)_removed/combo_2_4/decomposition/witness_sets/witness_set.txt");
