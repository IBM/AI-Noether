...
remainingAxioms = toList([Eph1 + Eel1 - Eph2- Eel2, p1*c - h*f1, p2*c - h*f2, lambda1*f1 - c, lambda2*f2 - c, Eel1 - mel*c^2, pel2^2 - p1^2 - p2^2 + 2*p1*p2*cosTh]);
...
f = openOut "results/compton/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_3_9/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/compton/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_3_9/decomposition/witness_sets/witness_set.txt");
