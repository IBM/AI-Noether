...
-- Output
f = openOut "results/time_dilation/dimensionality_check/2_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({4*L^2 - 4*d^2 - v^2*dt^2, F*dt - 1}) << endl;
