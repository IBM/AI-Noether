...
-- Output
f = openOut "results/time_dilation/dimensionality_check/2_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({F*dt - 1, c*dt - 2*L}) << endl;
