...
-- Output
f = openOut "results/time_dilation/dimensionality_check/3_axioms_removed/subset_8/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({4*L^2 - 4*d^2 - v^2*dt^2, F0*dt0 - 1, c*dt - 2*L}) << endl;
