...
-- Output
f = openOut "results/time_dilation/dimensionality_check/3_axioms_removed/subset_5/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({c*dt0 - 2*d, F0*dt0 - 1, c*dt - 2*L}) << endl;
