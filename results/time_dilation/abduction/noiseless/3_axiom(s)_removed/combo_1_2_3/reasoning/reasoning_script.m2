...
-- Output file
f = openOut "results/time_dilation/abduction/noiseless/3_axiom(s)_removed/combo_1_2_3/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/time_dilation/abduction/noiseless/3_axiom(s)_removed/combo_1_2_3/reasoning/reasoning_output.txt");
