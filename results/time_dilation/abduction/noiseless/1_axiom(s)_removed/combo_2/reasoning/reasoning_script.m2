...
-- Output file
f = openOut "results/time_dilation/abduction/noiseless/1_axiom(s)_removed/combo_2/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/time_dilation/abduction/noiseless/1_axiom(s)_removed/combo_2/reasoning/reasoning_output.txt");
