...
qList = toList([(100001262/10000000)*c^2*F0^2 - (10003017/10000)*c^2*F^2 - (10000810/10000)*F0^2*v^2]);
...
f = openOut "results/time_dilation/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_3/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/time_dilation/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_3/decomposition/witness_sets/witness_set.txt");
