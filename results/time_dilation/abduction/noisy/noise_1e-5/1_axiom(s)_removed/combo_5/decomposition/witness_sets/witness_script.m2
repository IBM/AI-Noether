...
qList = toList([(9989/10000)*c^2*F0^2 - (9876/10000)*c^2*F^2 - (10057/10000)*F0^2*v^2]);
...
f = openOut "results/time_dilation/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/time_dilation/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_5/decomposition/witness_sets/witness_set.txt");
