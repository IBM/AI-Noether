...
f = openOut "results/time_dilation/abduction/noisy/noise_1e-2/3_axiom(s)_removed/combo_2_3_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/time_dilation/abduction/noisy/noise_1e-2/3_axiom(s)_removed/combo_2_3_5/decomposition/witness_sets/witness_set.txt");
