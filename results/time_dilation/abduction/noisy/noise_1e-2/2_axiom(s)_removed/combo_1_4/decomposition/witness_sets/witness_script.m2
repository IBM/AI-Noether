...
f = openOut "results/time_dilation/abduction/noisy/noise_1e-2/2_axiom(s)_removed/combo_1_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/time_dilation/abduction/noisy/noise_1e-2/2_axiom(s)_removed/combo_1_4/decomposition/witness_sets/witness_set.txt");
