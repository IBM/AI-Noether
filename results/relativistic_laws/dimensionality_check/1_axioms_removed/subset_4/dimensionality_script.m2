...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/1_axioms_removed/subset_4/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({c^2*dt^2 - 4*L0^2 - v^2*dt^2}) << endl;
