...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/1_axioms_removed/subset_5/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m0*u0 - m*u}) << endl;
