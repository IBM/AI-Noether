...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/1_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({c*dt0 - 2*L0}) << endl;
