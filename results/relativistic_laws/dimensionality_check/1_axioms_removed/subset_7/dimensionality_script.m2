...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/1_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({dt*(c^2 - v^2) - 2*L*c}) << endl;
