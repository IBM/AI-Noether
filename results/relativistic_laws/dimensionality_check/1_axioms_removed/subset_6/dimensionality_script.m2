...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/1_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({u0*dt0 - u*dt}) << endl;
