...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/3_axioms_removed/subset_19/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({F*dt - 1, c*dt0 - 2*L0, dt*(c^2 - v^2) - 2*L*c}) << endl;
