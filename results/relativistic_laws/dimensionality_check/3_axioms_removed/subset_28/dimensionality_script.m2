...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/3_axioms_removed/subset_28/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({c*dt0 - 2*L0, c^2*dt^2 - 4*L0^2 - v^2*dt^2, dt*(c^2 - v^2) - 2*L*c}) << endl;
