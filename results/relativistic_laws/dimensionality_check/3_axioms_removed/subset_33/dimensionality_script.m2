...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/3_axioms_removed/subset_33/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({c^2*dt^2 - 4*L0^2 - v^2*dt^2, m0*u0 - m*u, dt*(c^2 - v^2) - 2*L*c}) << endl;
