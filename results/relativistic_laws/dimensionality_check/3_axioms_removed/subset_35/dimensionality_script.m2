...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/3_axioms_removed/subset_35/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m0*u0 - m*u, u0*dt0 - u*dt, dt*(c^2 - v^2) - 2*L*c}) << endl;
