...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/3_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({F0*dt0 - 1, F*dt - 1, m0*u0 - m*u}) << endl;
