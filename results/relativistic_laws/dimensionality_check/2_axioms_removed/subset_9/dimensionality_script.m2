...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/2_axioms_removed/subset_9/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({F*dt - 1, m0*u0 - m*u}) << endl;
