...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/2_axioms_removed/subset_15/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({c*dt0 - 2*L0, dt*(c^2 - v^2) - 2*L*c}) << endl;
