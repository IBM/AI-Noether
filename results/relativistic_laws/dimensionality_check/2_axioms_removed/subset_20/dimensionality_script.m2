...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/2_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m0*u0 - m*u, dt*(c^2 - v^2) - 2*L*c}) << endl;
