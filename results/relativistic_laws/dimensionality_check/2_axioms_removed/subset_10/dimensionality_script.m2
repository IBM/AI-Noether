...
-- Output
f = openOut "results/relativistic_laws_updated/dimensionality_check/2_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({F*dt - 1, u0*dt0 - u*dt}) << endl;
