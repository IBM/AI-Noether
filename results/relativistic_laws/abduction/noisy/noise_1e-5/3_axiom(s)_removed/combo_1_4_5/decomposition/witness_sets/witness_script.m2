...
remainingAxioms = toList([F*dt - 1, c*dt0 - 2*L0, u0*dt0 - u*dt, dt*(c^2 - v^2) - 2*L*c]);
...
f = openOut "results/relativistic_laws_updated/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_1_4_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/relativistic_laws_updated/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_1_4_5/decomposition/witness_sets/witness_set.txt");
