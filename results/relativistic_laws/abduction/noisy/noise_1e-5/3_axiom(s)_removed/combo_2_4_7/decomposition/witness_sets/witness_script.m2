...
remainingAxioms = toList([F0*dt0 - 1, c*dt0 - 2*L0, m0*u0 - m*u, u0*dt0 - u*dt]);
...
f = openOut "results/relativistic_laws_updated/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_4_7/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/relativistic_laws_updated/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_4_7/decomposition/witness_sets/witness_set.txt");
