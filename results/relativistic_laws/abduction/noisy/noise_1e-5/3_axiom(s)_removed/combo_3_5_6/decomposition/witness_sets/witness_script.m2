...
remainingAxioms = toList([F0*dt0 - 1, F*dt - 1, c^2*dt^2 - 4*L0^2 - v^2*dt^2, dt*(c^2 - v^2) - 2*L*c]);
...
f = openOut "results/relativistic_laws_updated/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_3_5_6/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/relativistic_laws_updated/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_3_5_6/decomposition/witness_sets/witness_set.txt");
