...
remainingAxioms = toList([F0*dt0 - 1, c*dt0 - 2*L0, c^2*dt^2 - 4*L0^2 - v^2*dt^2, m0*u0 - m*u, u0*dt0 - u*dt, dt*(c^2 - v^2) - 2*L*c]);
qList = toList([(9986/10000)*c^2*F0^2-(10012/10000)*c^2*F^2-(10104/10000)*F0^2*v^2, (9927/10000)*c^2*m0^2*u0-(9895/10000)*c^2*u0*m^2+(9992/10000)*v^2*u0*m^2, (10032/10000)*c^2*L0^2-(9984/10000)*c^2*L^2-(10011/10000)*v^2*L0^2]);
...
f = openOut "results/relativistic_laws_updated/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_2/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/relativistic_laws_updated/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_2/decomposition/witness_sets/witness_set.txt");
