...
f = openOut "results/relativistic_laws_updated/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_1_2/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/relativistic_laws_updated/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_1_2/decomposition/witness_sets/witness_set.txt");
