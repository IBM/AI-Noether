...
measuredVariables = toList([v, c, F0, F]);
nonMeasuredVariables = toList([dt, dt0, L0, L, m0, u0, m, u]);
...
f = openOut "results/relativistic_laws_updated/projection/target_1/projection_output.txt";
