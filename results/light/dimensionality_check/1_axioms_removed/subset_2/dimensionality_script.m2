...
-- Output
f = openOut "results/light/dimensionality_check/1_axioms_removed/subset_2/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({100*dA - 2*(314)*(r^2)*sintheta*dtheta}) << endl;
