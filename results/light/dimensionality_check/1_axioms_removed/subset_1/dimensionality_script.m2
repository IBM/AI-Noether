...
-- Output
f = openOut "results/light/dimensionality_check/1_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({S * r^2 - qc^2 * ap^2 * sintheta^2}) << endl;
