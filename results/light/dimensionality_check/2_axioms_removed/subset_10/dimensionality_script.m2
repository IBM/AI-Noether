...
-- Output
f = openOut "results/light/dimensionality_check/2_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({4 - 3*sintheta^3 * dtheta, 2*ap^2 - w^4 * x0^2}) << endl;
