...
-- Output
f = openOut "results/light/dimensionality_check/2_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({100*dA - 2*(314)*(r^2)*sintheta*dtheta, 2*ap^2 - w^4 * x0^2}) << endl;
