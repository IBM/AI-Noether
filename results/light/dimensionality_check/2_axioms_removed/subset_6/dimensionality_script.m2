...
-- Output
f = openOut "results/light/dimensionality_check/2_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({100*dA - 2*(314)*(r^2)*sintheta*dtheta, 4 - 3*sintheta^3 * dtheta}) << endl;
