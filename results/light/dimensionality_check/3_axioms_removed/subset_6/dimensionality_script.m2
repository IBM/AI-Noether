...
-- Output
f = openOut "results/light/dimensionality_check/3_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({S * r^2 - qc^2 * ap^2 * sintheta^2, 4 - 3*sintheta^3 * dtheta, 2*ap^2 - w^4 * x0^2}) << endl;
