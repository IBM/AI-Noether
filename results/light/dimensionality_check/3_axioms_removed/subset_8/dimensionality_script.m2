...
-- Output
f = openOut "results/light/dimensionality_check/3_axioms_removed/subset_8/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({100*dA - 2*(314)*(r^2)*sintheta*dtheta, P - S * dA, 2*ap^2 - w^4 * x0^2}) << endl;
