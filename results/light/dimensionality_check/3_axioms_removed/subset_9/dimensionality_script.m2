...
-- Output
f = openOut "results/light/dimensionality_check/3_axioms_removed/subset_9/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({100*dA - 2*(314)*(r^2)*sintheta*dtheta, 4 - 3*sintheta^3 * dtheta, 2*ap^2 - w^4 * x0^2}) << endl;
