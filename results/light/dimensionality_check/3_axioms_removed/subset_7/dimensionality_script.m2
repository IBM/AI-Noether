...
-- Output
f = openOut "results/light/dimensionality_check/3_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({100*dA - 2*(314)*(r^2)*sintheta*dtheta, P - S * dA, 4 - 3*sintheta^3 * dtheta}) << endl;
