...
remainingAxioms = delete(P - S * dA, remainingAxioms);
...
-- Output
f = openOut "results/light/dimensionality_check/3_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({S * r^2 - qc^2 * ap^2 * sintheta^2, 100*dA - 2*(314)*(r^2)*sintheta*dtheta, P - S * dA}) << endl;
