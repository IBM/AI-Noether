...
-- Output
f = openOut "results/light/dimensionality_check/3_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({S * r^2 - qc^2 * ap^2 * sintheta^2, 100*dA - 2*(314)*(r^2)*sintheta*dtheta, 2*ap^2 - w^4 * x0^2}) << endl;
