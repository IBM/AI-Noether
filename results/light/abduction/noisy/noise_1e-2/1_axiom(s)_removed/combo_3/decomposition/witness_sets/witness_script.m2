...
qList = toList([(7589/100)*P - (31910/100)*qc^2*w^4*x0^2]);
...
f = openOut "results/light/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_3/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/light/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_3/decomposition/witness_sets/witness_set.txt");
