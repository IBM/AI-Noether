...
remainingAxioms = toList([P - S * dA, ap^2 - (1/2)*w^4 * x0^2]);
...
f = openOut "results/light/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_1_2_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/light/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_1_2_4/decomposition/witness_sets/witness_set.txt");
