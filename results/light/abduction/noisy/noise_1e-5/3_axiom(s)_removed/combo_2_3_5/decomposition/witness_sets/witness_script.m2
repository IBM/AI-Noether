...
remainingAxioms = toList([S * r^2 - qc^2 * ap^2 * sintheta^2, 4/3 - sintheta^3 * dtheta]);
...
f = openOut "results/light/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_3_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/light/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_3_5/decomposition/witness_sets/witness_set.txt");
