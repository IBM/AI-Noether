...
remainingAxioms = toList([dA - 2*(314/100)*r^2*sintheta*dtheta, P - S * dA, 4/3 - sintheta^3 * dtheta, ap^2 - (1/2)*w^4 * x0^2]);
...
f = openOut "results/light/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_1/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/light/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_1/decomposition/witness_sets/witness_set.txt");
