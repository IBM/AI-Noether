...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_14/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ph - p0 - dp, sigma - e * ph * mup - e * n * muN}) << endl;
