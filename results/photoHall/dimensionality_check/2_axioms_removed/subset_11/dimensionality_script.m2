...
remainingAxioms = delete(muH - r * mu, remainingAxioms);
...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_11/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({muH - r * mu, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n}) << endl;
