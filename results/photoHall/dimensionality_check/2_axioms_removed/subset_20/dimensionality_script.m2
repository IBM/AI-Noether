...
remainingAxioms = delete(dp - dn, remainingAxioms);
...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({dp - dn, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n}) << endl;
