...
remainingAxioms = delete(beta * mup - muN, remainingAxioms);
...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({beta * mup - muN, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n}) << endl;
