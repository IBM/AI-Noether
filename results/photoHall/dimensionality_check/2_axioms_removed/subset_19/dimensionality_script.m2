...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_19/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({dp - dn, sigma - e * ph * mup - e * n * muN}) << endl;
