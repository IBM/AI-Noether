...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_5/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({beta * mup - muN, sigma - e * ph * mup - e * n * muN}) << endl;
