...
remainingAxioms = delete(ph - p0 - dp, remainingAxioms);
...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_15/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ph - p0 - dp, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n}) << endl;
