...
-- Output
f = openOut "results/photoHall/dimensionality_check/2_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({beta * mup - muN, muH - r * mu}) << endl;
