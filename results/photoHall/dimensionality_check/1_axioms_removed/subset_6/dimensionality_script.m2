...
-- Output
f = openOut "results/photoHall/dimensionality_check/1_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({sigma - e * ph * mup - e * n * muN}) << endl;
