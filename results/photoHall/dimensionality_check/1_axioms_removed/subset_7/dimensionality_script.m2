...
-- Output
f = openOut "results/photoHall/dimensionality_check/1_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n}) << endl;
