...
-- Input data
remainingAxioms = toList([beta * mup - muN, ph - p0 - dp, sigma - e * ph * mup - e * n * muN, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n]);
...
-- Output file
f = openOut "results/photoHall/abduction/noiseless/3_axiom(s)_removed/combo_2_4_5/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/photoHall/abduction/noiseless/3_axiom(s)_removed/combo_2_4_5/reasoning/reasoning_output.txt");
