...
R = CC[ph, dp, mu, muN, muH, n, dsigma2dn, e, mup, p0, dn, beta, r, sigma, H, MonomialOrder => Lex];

remainingAxioms = toList([beta * mup - muN, muH - r * mu, ph - p0 - dp, dp - dn, sigma - e * ph * mup - e * n * muN, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n]);
qList = toList([(9989734/10000000)*r*e*mup*dn*beta^2 + (9997691/10000000)*r*e*mup*dn*beta - (10000178/10000000)*r*sigma + (10000119/10000000)*e*p0*sigma*H + (9999725/10000000)*e*dn*beta*sigma*H + (9998072/10000000)*e*dn*sigma*H]);
...
f = openOut "results/photoHall/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/photoHall/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt");
