...
f = openOut "results/photoHall/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_3_6/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/photoHall/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_3_6/decomposition/witness_sets/witness_set.txt");
