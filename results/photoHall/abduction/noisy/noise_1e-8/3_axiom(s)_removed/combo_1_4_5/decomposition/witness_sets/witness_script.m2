...
remainingAxioms = toList([muH - r * mu, ph - p0 - dp, sigma - e * ph * mup - e * n * muN, H * (ph + beta * n)^2 * e - r * ph + r * beta^2 * n]);
...
f = openOut "results/photoHall/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_4_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/photoHall/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_4_5/decomposition/witness_sets/witness_set.txt");
