...
remainingAxioms = toList([beta * mup - muN, ph - p0 - dp, dp - dn, sigma - e * ph * mup - e * n * muN]);
...
f = openOut "results/photoHall/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_2_4_7/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/photoHall/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_2_4_7/decomposition/witness_sets/witness_set.txt");
