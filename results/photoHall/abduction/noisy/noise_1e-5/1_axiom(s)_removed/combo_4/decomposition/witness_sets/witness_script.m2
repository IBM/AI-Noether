...
qList = toList([(9987/10000)*r*e*mup*dn*beta^2 + (9963/10000)*r*e*mup*dn*beta - (10231/10000)*r*sigma + (10124/10000)*e*p0*sigma*H + (9987/10000)*e*dn*beta*sigma*H + (9972/10000)*e*dn*sigma*H]);
...
f = openOut "results/photoHall/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/photoHall/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt");
