...
qList = toList([(94/100)*r*e*mup*dn*beta^2 + (123/100)*r*e*mup*dn*beta - (101/100)*r*sigma + (113/100)*e*p0*sigma*H + (98/100)*e*dn*beta*sigma*H + (97/100)*e*dn*sigma*H]);
...
f = openOut "results/photoHall/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/photoHall/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt");
