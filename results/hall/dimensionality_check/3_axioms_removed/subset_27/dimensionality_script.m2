...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_27/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, Q - N*qe, V - L*h*d}) << endl;
