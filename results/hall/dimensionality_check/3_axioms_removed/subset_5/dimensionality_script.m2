...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_5/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, Fe - qe*E, Q - N*qe}) << endl;
