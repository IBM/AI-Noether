...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_28/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, n*V - N, V - L*h*d}) << endl;
