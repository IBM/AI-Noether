...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_18/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, E*h - UH, V - L*h*d}) << endl;
