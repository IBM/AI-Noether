...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_22/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, v*dt - L, V - L*h*d}) << endl;
