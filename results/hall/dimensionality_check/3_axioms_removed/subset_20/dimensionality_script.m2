...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, v*dt - L, Q - N*qe}) << endl;
