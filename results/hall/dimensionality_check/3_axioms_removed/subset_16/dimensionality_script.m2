...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_16/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, E*h - UH, Q - N*qe}) << endl;
