...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, Fe - qe*E, V - L*h*d}) << endl;
