...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_13/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, Fm - Fe, V - L*h*d}) << endl;
