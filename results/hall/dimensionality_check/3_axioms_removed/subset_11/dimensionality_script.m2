...
remainingAxioms = delete(Fm - qe*v*B, remainingAxioms);
remainingAxioms = delete(Fm - Fe, remainingAxioms);
remainingAxioms = delete(Q - N*qe, remainingAxioms);
...
-- Output
f = openOut "results/hall/dimensionality_check/3_axioms_removed/subset_11/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fm - qe*v*B, Fm - Fe, Q - N*qe}) << endl;
