...
remainingAxioms = toList([Fm - qe*v*B, E*h - UH, i*dt - Q, Q - N*qe, n*V - N, V - L*h*d]);
...
f = openOut "results/hall/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_2_3_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/hall/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_2_3_5/decomposition/witness_sets/witness_set.txt");
