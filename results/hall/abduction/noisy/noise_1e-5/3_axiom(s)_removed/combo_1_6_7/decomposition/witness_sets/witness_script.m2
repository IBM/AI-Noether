...
f = openOut "results/hall/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_1_6_7/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/hall/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_1_6_7/decomposition/witness_sets/witness_set.txt");
