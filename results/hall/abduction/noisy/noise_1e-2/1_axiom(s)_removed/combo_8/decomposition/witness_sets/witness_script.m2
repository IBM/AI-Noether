...
qList = toList([(121/100)*N*qe*UH - (98/100)*i*B*h*L]);
...
f = openOut "results/hall/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_8/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/hall/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_8/decomposition/witness_sets/witness_set.txt");
