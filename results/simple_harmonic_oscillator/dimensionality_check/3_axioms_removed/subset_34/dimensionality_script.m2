...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_34/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({T*omega-2*Pi, Tj-j*T, sintheta - theta}) << endl;
