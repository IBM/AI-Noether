...
remainingAxioms = delete(Tj-j*T, remainingAxioms);
...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_13/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, d*omega^2-ad, Tj-j*T}) << endl;
