...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, T*omega-2*Pi, d*omega^2-ad}) << endl;
