...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_31/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, Tj-j*T, sintheta - theta}) << endl;
