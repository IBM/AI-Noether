...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_23/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, d*omega^2-ad, Tj-j*T}) << endl;
