...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_26/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, T*omega-2*Pi, d*omega^2-ad}) << endl;
