...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_14/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, d*omega^2-ad, sintheta - theta}) << endl;
