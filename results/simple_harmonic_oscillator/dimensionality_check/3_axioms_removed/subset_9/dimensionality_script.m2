...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_9/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, d-L*theta, sintheta - theta}) << endl;
