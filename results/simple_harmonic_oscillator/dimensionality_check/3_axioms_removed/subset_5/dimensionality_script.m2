...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_5/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, Fd - m*ad, sintheta - theta}) << endl;
