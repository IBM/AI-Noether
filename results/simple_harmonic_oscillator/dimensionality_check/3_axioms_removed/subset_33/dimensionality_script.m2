...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_33/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({T*omega-2*Pi, d*omega^2-ad, sintheta - theta}) << endl;
