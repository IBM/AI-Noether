...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_27/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, T*omega-2*Pi, Tj-j*T}) << endl;
