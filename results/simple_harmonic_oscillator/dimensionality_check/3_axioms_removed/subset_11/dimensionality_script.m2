...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_11/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, T*omega-2*Pi, Tj-j*T}) << endl;
