...
remainingAxioms = delete(ad-g*sintheta, remainingAxioms);
remainingAxioms = delete(T*omega-2*Pi, remainingAxioms);
remainingAxioms = delete(d*omega^2-ad, remainingAxioms);
...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, T*omega-2*Pi, d*omega^2-ad}) << endl;
