...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_30/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, d*omega^2-ad, sintheta - theta}) << endl;
