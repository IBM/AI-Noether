...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, Fd - m*ad, d-L*theta}) << endl;
