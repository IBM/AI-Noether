...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_35/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d*omega^2-ad, Tj-j*T, sintheta - theta}) << endl;
