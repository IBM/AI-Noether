...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_24/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, d*omega^2-ad, sintheta - theta}) << endl;
