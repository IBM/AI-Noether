...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_16/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, d-L*theta, T*omega-2*Pi}) << endl;
