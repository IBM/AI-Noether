...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_8/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, d-L*theta, Tj-j*T}) << endl;
