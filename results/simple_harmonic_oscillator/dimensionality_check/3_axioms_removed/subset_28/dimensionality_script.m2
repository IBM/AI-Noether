...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_28/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, T*omega-2*Pi, sintheta - theta}) << endl;
