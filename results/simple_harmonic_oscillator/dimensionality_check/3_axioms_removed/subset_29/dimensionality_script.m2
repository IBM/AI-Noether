...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_29/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, d*omega^2-ad, Tj-j*T}) << endl;
