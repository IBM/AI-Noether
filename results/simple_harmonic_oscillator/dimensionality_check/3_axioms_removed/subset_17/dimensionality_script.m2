...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_17/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, d-L*theta, d*omega^2-ad}) << endl;
