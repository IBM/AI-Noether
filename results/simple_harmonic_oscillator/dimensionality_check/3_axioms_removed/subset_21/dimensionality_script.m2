...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_21/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, T*omega-2*Pi, Tj-j*T}) << endl;
