...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_25/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, Tj-j*T, sintheta - theta}) << endl;
