...
remainingAxioms = delete(Fd - m*ad, remainingAxioms);
...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, Fd - m*ad, d*omega^2-ad}) << endl;
