...
remainingAxioms = delete(d-L*theta, remainingAxioms);
...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, d-L*theta, T*omega-2*Pi}) << endl;
