...
-- Output
f = openOut "results/pendulum/dimensionality_check/3_axioms_removed/subset_15/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({ad-g*sintheta, Tj-j*T, sintheta - theta}) << endl;
