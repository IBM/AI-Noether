...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_11/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, sintheta - theta}) << endl;
