...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_12/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, T*omega-2*Pi}) << endl;
