...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_13/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, d*omega^2-ad}) << endl;
