...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_17/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({T*omega-2*Pi, Tj-j*T}) << endl;
