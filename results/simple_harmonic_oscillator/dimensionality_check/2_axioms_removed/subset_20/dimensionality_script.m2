...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d*omega^2-ad, sintheta - theta}) << endl;
