...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_18/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({T*omega-2*Pi, sintheta - theta}) << endl;
