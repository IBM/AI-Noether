...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_8/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fd - m*ad, T*omega-2*Pi}) << endl;
