...
-- Output
f = openOut "results/pendulum/dimensionality_check/2_axioms_removed/subset_15/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({d-L*theta, sintheta - theta}) << endl;
