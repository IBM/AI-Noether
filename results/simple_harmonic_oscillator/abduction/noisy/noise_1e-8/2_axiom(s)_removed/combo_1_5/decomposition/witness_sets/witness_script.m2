...
remainingAxioms = toList([d-L*theta, T*omega-2*Pii, d*omega^2-ad, sintheta - theta]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_1_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_1_5/decomposition/witness_sets/witness_set.txt");
