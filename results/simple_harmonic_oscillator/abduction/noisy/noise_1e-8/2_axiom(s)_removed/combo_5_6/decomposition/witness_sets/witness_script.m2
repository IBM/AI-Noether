...
remainingAxioms = toList([ad-g*sintheta, d-L*theta, T*omega-2*Pii, d*omega^2-ad]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_5_6/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-8/2_axiom(s)_removed/combo_5_6/decomposition/witness_sets/witness_set.txt");
