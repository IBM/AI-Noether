...
remainingAxioms = toList([ad-g*sintheta, d-L*theta, Tj-j*T]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_3_4_6/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_3_4_6/decomposition/witness_sets/witness_set.txt");
