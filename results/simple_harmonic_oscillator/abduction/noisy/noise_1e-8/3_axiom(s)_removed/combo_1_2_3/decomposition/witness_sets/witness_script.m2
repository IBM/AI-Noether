...
remainingAxioms = toList([d*omega^2-ad, Tj-j*T, sintheta - theta]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_2_3/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_2_3/decomposition/witness_sets/witness_set.txt");
