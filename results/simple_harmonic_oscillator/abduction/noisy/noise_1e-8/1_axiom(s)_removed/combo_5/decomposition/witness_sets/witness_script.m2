...
remainingAxioms = toList([ad-g*sintheta, d-L*theta, T*omega-2*Pii, d*omega^2-ad, sintheta - theta]);
qList = toList([(9999681/10000000)*g*Tj^2-(40000843/10000000)*L*j^2*Pii^2]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_5/decomposition/witness_sets/witness_set.txt");
