...
remainingAxioms = toList([ad-g*sintheta, d-L*theta, T*omega-2*Pii, Tj-j*T, sintheta - theta]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt");
