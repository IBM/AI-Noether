...
f = openOut "results/pendulum/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_5_6/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_2_5_6/decomposition/witness_sets/witness_set.txt");
