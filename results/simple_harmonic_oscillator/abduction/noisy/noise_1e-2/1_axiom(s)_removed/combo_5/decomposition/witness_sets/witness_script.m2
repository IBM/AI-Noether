...
qList = toList([(101/100)*g*Tj^2-(404/100)*L*j^2*Pii^2]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-2/1_axiom(s)_removed/combo_5/decomposition/witness_sets/witness_set.txt");
