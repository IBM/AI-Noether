...
remainingAxioms = toList([T*omega-2*Pi, d*omega^2-ad, Tj-j*T]);
...
f = openOut "results/pendulum/abduction/noisy/noise_1e-2/3_axiom(s)_removed/combo_1_2_6/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/pendulum/abduction/noisy/noise_1e-2/3_axiom(s)_removed/combo_1_2_6/decomposition/witness_sets/witness_set.txt");
