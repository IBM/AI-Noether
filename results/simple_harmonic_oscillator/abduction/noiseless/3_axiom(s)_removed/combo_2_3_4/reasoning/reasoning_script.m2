...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/3_axiom(s)_removed/combo_2_3_4/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/3_axiom(s)_removed/combo_2_3_4/reasoning/reasoning_output.txt");
