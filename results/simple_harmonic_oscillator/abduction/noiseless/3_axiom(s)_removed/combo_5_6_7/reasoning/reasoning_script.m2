...
-- Input data
remainingAxioms = toList([ad-g*sintheta, Fd - m*ad, d-L*theta, T*omega-2*Pi]);
...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/3_axiom(s)_removed/combo_5_6_7/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/3_axiom(s)_removed/combo_5_6_7/reasoning/reasoning_output.txt");
