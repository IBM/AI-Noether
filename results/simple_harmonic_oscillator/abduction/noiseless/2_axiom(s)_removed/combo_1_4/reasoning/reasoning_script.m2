...
-- Input data
remainingAxioms = toList([Fd - m*ad, d-L*theta, d*omega^2-ad, Tj-j*T, sintheta - theta]);
...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_1_4/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_1_4/reasoning/reasoning_output.txt");
