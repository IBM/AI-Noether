...
-- Input data
remainingAxioms = toList([ad-g*sintheta, Fd - m*ad, d*omega^2-ad, Tj-j*T, sintheta - theta]);
...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_3_4/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_3_4/reasoning/reasoning_output.txt");
