...
-- Input data
remainingAxioms = toList([d-L*theta, T*omega-2*Pi, d*omega^2-ad, Tj-j*T, sintheta - theta]);
...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_1_2/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_1_2/reasoning/reasoning_output.txt");
