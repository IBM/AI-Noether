...
-- Input data
remainingAxioms = toList([ad-g*sintheta, Fd - m*ad, d-L*theta, T*omega-2*Pi, sintheta - theta]);
...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_5_6/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/2_axiom(s)_removed/combo_5_6/reasoning/reasoning_output.txt");
