...
-- Input data
remainingAxioms = toList([ad-g*sintheta, Fd - m*ad, d-L*theta, T*omega-2*Pi, Tj-j*T, sintheta - theta]);
...
-- Output file
f = openOut "results/pendulum/abduction/noiseless/1_axiom(s)_removed/combo_5/reasoning/reasoning_output.txt";
...
print("Reasoning complete. Output written to results/pendulum/abduction/noiseless/1_axiom(s)_removed/combo_5/reasoning/reasoning_output.txt");
