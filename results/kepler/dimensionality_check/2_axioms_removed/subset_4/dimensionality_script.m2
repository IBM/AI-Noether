...
-- Output
f = openOut "results/real/kepler/dimensionality_check/2_axioms_removed/subset_4/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m1*d1-m2*d2, w*p - 1}) << endl;
