...
-- Output
f = openOut "results/real/kepler/dimensionality_check/2_axioms_removed/subset_8/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fc - m2*d2*w^2, Fc - Fg}) << endl;
