...
-- Output
f = openOut "results/real/kepler/dimensionality_check/2_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m1*d1-m2*d2, Fg*(d1+d2)^2 - m1*m2}) << endl;
