...
-- Output
f = openOut "results/real/kepler/dimensionality_check/3_axioms_removed/subset_9/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fg*(d1+d2)^2 - m1*m2, Fc - Fg, w*p - 1}) << endl;
