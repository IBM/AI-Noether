...
-- Output
f = openOut "results/real/kepler/dimensionality_check/3_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m1*d1-m2*d2, Fc - Fg, w*p - 1}) << endl;
