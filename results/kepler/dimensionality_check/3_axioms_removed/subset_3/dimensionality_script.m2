...
-- Output
f = openOut "results/real/kepler/dimensionality_check/3_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({m1*d1-m2*d2, Fg*(d1+d2)^2 - m1*m2, w*p - 1}) << endl;
