...
-- Output
f = openOut "results/real/kepler/dimensionality_check/3_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Fc - m2*d2*w^2, Fc - Fg, w*p - 1}) << endl;
