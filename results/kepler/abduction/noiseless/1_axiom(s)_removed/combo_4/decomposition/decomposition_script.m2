...
-- Output file
f = openOut "results/real/kepler/abduction/noiseless/1_axiom(s)_removed/combo_4/decomposition/decomposition_output.txt";
...
print("Decomposition complete. Output written to results/real/kepler/abduction/noiseless/1_axiom(s)_removed/combo_4/decomposition/decomposition_output.txt");
