...
remainingAxioms = toList([m1*d1-m2*d2, Fg*(d1+d2)^2 - m1*m2]);
...
f = openOut "results/kepler/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_3_4_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/kepler/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_3_4_5/decomposition/witness_sets/witness_set.txt");
