...
R = CC[Fc, Fg, w, m1, d1, m2, d2, p, MonomialOrder => Lex];

remainingAxioms = toList([m1*d1-m2*d2, Fg*(d1+d2)^2 - m1*m2, Fc - m2*d2*w^2, w*p - 1]);
qList = toList([(10011/10000)*m1*m2*p^2-(9982/10000)*m1*d1*d2^2-(9953/10000)*m2*d1^2*d2-(20190/10000)*m2*d1*d2^2]);
...
f = openOut "results/kepler/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/kepler/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_4/decomposition/witness_sets/witness_set.txt");
