...
f = openOut "results/inelastic_collision/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_3_6_7/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/inelastic_collision/abduction/noisy/noise_1e-5/3_axiom(s)_removed/combo_3_6_7/decomposition/witness_sets/witness_set.txt");
