...
qList = toList([(159013/10000)*mm^2*c^4 - (90023/10000)*pm^2*c^2]);
...
f = openOut "results/inelastic_collision/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_8/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/inelastic_collision/abduction/noisy/noise_1e-5/1_axiom(s)_removed/combo_8/decomposition/witness_sets/witness_set.txt");
