...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_32/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pc - pm, mr - mm}) << endl;
