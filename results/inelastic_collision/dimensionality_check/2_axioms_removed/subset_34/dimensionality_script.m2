...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_34/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({vm - 4/5*c, mr - mm}) << endl;
