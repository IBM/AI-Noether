...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_16/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2, Ec^2 - (mc*c)^2 - (pc*c)^2}) << endl;
