...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_24/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ec^2 - (mc*c)^2 - (pc*c)^2, vm - 4/5*c}) << endl;
