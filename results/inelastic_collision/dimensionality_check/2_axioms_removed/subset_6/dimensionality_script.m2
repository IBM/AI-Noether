...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_6/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pm^2*(c^2 - vm^2) - mm^2*vm^2*c^2, vm - 4/5*c}) << endl;
