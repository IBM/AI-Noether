...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_59/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2, pc - pm, vm - 4/5*c}) << endl;
