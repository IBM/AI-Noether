...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_24/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pm^2*(c^2 - vm^2) - mm^2*vm^2*c^2, pc - pm, mr - mm}) << endl;
