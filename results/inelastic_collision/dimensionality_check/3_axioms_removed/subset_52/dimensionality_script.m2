...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_52/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2, Ec^2 - (mc*c)^2 - (pc*c)^2, vm - 4/5*c}) << endl;
