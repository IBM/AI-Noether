...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/1_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2}) << endl;
