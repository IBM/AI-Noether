...
remainingAxioms = toList([pm^2*(c^2 - vm^2) - mm^2*vm^2*c^2, Em^2 - (mm*c^2)^2 - (pm*c)^2, 2*Em*Er - Ec^2 + Em^2 + Er^2, pc - pm, vm - 4/5*c, mr - mm]);
...
f = openOut "results/inelastic_collision/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_3_4_9/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/inelastic_collision/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_3_4_9/decomposition/witness_sets/witness_set.txt");
