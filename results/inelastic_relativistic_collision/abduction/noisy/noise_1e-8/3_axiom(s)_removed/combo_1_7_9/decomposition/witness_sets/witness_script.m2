...
remainingAxioms = toList([Em^2 - (mm*c^2)^2 - (pm*c)^2, Er - mr*c^2, Ec^2 - (mc*c)^2 - (pc*c)^2, 2*Em*Er - Ec^2 + Em^2 + Er^2, pc - pm, mr - mm]);
...
f = openOut "results/inelastic_collision/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_7_9/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/inelastic_collision/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_7_9/decomposition/witness_sets/witness_set.txt");
