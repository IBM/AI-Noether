...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_20/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2, mr - mm}) << endl;
