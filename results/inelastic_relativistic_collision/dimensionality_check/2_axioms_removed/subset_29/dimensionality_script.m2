...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/2_axioms_removed/subset_29/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({2*Em*Er - Ec^2 + Em^2 + Er^2, mr - mm}) << endl;
