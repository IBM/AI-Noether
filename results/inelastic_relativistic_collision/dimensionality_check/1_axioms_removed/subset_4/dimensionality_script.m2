...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/1_axioms_removed/subset_4/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ec^2 - (mc*c)^2 - (pc*c)^2}) << endl;
