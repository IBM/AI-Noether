...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_57/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2, 2*Em*Er - Ec^2 + Em^2 + Er^2, mr - mm}) << endl;
