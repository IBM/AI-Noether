...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_60/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Er - mr*c^2, pc - pm, mr - mm}) << endl;
