...
remainingAxioms = delete(mr - mm, remainingAxioms);
...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_28/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pm^2*(c^2 - vm^2) - mm^2*vm^2*c^2, mr - mm, pc^2*(c^2 - vc^2) - mc^2*vc^2*c^2}) << endl;
