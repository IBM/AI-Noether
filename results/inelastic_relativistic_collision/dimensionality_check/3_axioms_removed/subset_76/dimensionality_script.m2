...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_76/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({2*Em*Er - Ec^2 + Em^2 + Er^2, pc - pm, mr - mm}) << endl;
