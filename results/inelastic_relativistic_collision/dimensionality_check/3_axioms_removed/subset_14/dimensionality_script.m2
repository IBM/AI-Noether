...
-- Output
f = openOut "results/inelastic_collision/dimensionality_check/3_axioms_removed/subset_14/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({pm^2*(c^2 - vm^2) - mm^2*vm^2*c^2, Ec^2 - (mc*c)^2 - (pc*c)^2, 2*Em*Er - Ec^2 + Em^2 + Er^2}) << endl;
