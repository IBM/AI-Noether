...
f = openOut "results/escape_velocity/abduction/noisy/noise_1e-5/2_axiom(s)_removed/combo_4_5/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/escape_velocity/abduction/noisy/noise_1e-5/2_axiom(s)_removed/combo_4_5/decomposition/witness_sets/witness_set.txt");
