...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/2_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ugf - 0, Eki + Ugi - Ekf - Ugf}) << endl;
