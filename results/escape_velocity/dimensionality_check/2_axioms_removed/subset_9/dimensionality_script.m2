...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/2_axioms_removed/subset_9/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ugi * r + G * M * m, Eki + Ugi - Ekf - Ugf}) << endl;
