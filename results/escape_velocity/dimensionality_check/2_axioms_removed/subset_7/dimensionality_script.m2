...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/2_axioms_removed/subset_7/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ekf - 0, Eki + Ugi - Ekf - Ugf}) << endl;
