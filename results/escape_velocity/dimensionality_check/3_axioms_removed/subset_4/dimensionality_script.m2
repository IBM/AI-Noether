...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/3_axioms_removed/subset_4/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Eki - 1/2 * m * ve^2, Ugi * r + G * M * m, Ugf - 0}) << endl;
