...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/3_axioms_removed/subset_10/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Ugi * r + G * M * m, Ugf - 0, Eki + Ugi - Ekf - Ugf}) << endl;
