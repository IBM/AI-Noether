...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/1_axioms_removed/subset_5/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Eki + Ugi - Ekf - Ugf}) << endl;
