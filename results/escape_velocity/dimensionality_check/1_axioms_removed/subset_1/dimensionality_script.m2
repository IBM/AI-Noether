...
-- Output
f = openOut "results/escape_velocity/dimensionality_check/1_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({Eki - 1/2 * m * ve^2}) << endl;
