...
-- Output
f = openOut "results/hagen/dimensionality_check/3_axioms_removed/subset_1/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({4*r*c2*mu - r*dp, delP + L*dp, c0 + c2*Rad^2}) << endl;
