...
remainingAxioms = delete(c0 + c2*Rad^2, remainingAxioms);
...
-- Output
f = openOut "results/hagen/dimensionality_check/3_axioms_removed/subset_3/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({4*r*c2*mu - r*dp, c0 + c2*Rad^2, u - c0 - r^2*c2}) << endl;
