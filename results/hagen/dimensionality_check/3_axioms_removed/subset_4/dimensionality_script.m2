...
-- Output
f = openOut "results/hagen/dimensionality_check/3_axioms_removed/subset_4/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({delP + L*dp, c0 + c2*Rad^2, u - c0 - r^2*c2}) << endl;
