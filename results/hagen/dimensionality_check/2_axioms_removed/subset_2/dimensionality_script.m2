...
-- Output
f = openOut "results/hagen/dimensionality_check/2_axioms_removed/subset_2/dimensionality_output.txt";
...
f << "Removed axioms: " << toString({4*r*c2*mu - r*dp, c0 + c2*Rad^2}) << endl;
