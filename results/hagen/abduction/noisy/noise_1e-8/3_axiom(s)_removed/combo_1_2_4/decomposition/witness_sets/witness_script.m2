...
remainingAxioms = toList([c0 + c2*Rad^2]);
...
f = openOut "results/hagen/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_2_4/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/hagen/abduction/noisy/noise_1e-8/3_axiom(s)_removed/combo_1_2_4/decomposition/witness_sets/witness_set.txt");
