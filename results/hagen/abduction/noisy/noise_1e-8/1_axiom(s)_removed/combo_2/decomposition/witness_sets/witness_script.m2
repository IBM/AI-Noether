...
qList = toList([(9999314/10000000)*r^3*delP - (10012156/10000000)*r*Rad^2*delP + (39997823/10000000)*r*u*L*mu]);
...
f = openOut "results/hagen/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_2/decomposition/witness_sets/witness_set.txt";
f << "variable ordering: ";
...
close f;
print("Witness set computation complete. Output written to results/hagen/abduction/noisy/noise_1e-8/1_axiom(s)_removed/combo_2/decomposition/witness_sets/witness_set.txt");
